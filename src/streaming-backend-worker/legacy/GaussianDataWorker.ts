...
import type { GaussianSource } from "../../streaming-backend-impl/GaussianSource";
import { GaussianLod, type GaussianLodPacking } from "../../streaming-backend-impl/GaussianLod";
import { GaussianOctree } from "../../streaming-backend-impl/GaussianOctree";
import { packShRgb8e8 } from "../../streaming-backend-impl/GaussianSh";
import { DistanceAwareRadialLodPackingStrategy } from "../../streaming-backend-impl/lod-packing/DistanceAwareRadialLodPackingStrategy";
import type {
...
function pack(
  ...
  const source: GaussianSource = lod.octree.data;
