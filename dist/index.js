import { StorageBufferAttribute as kt, Vector3 as T, Quaternion as mr, Box3 as le, Object3D as Gs, Matrix4 as Dt, Ray as fr, LineSegments as yr, BufferGeometry as xr, Float32BufferAttribute as br, LineBasicMaterial as wr, BoxGeometry as vr, MeshBasicMaterial as Nr, DoubleSide as Tr, InstancedMesh as Sr, Color as _r, IndirectStorageBufferAttribute as Mr, Vector4 as Cr, Scene as Oe, PassNode as ps, HalfFloatType as gs, SRGBColorSpace as Er, StorageTexture as ms, NoColorSpace as kr, RedFormat as Ar, FloatType as Rr, NearestFilter as fs, PerspectiveCamera as Lr, Vector2 as Ir } from "three/webgpu";
import { property as A, bool as Ut, exp as Vs, float as G, storage as y, uint as m, vec3 as ae, mix as zr, wgslFn as L, instanceIndex as et, workgroupArray as j, workgroupId as J, invocationLocalIndex as xt, uniform as jt, uvec2 as Kt, Fn as ne, If as O, Return as pt, vec4 as Q, mat4 as ys, normalize as Or, sqrt as Ct, clamp as yt, log as Pr, ceil as xs, vec2 as ft, ivec2 as Zt, int as bs, floor as ke, subgroupIndex as ye, invocationSubgroupIndex as xe, subgroupSize as be, atomicStore as Br, storageTexture as Ae, select as mt, Loop as Wt, Break as qt, Continue as we, max as ws, workgroupBarrier as vs, atomicAdd as Bt, textureStore as Ns, colorSpaceToWorking as Fr } from "three/tsl";
class Pe {
  count;
  shDegree;
  shCoefficientCount;
...
function Dr(n, t, e) {
  ...
  if (s === 0) return 0;
  const r = Math.min(127, Math.max(-126, Math.ceil(Math.log2(s)))), i = 127 / 2 ** r, a = ve(n, i), o = ve(t, i), l = ve(e, i), h = r + 127;
...
class Vr {
  ...
  parse(t) {
    ...
    const l = jr(t, e), h = (g) => s.get(g), u = r.map(
      (g) => h(`f_rest_${g}`)
    ...
    for (let g = 0; g < d; g++) {
      ...
      const k = g * a * 4;
      b[k] = l(g, h("f_dc_0")), b[k + 1] = l(g, h("f_dc_1")), b[k + 2] = l(g, h("f_dc_2"));
      for (let N = 1; N < a; N++) {
        const z = k + N * 4, B = N - 1;
        for (let R = 0; R < 3; R++) {
          const U = u[R * i + B];
    ...
    return new Pe(
      {
        means: se("ply.means", c),
        scalesOpacity: se("ply.scales-opacity", p),
        rotations: se("ply.rotations-xyzw", f),
        shCoefficients: se("ply.sh-coefficients", b)
      },
      {
        count: d,
        shDegree: o - 1,
...
function $r(n) {
  ...
  for (const f of a) {
    ...
    if (b[0] === "format") {
      ...
      d.push({ name: w, type: g, byteOffset: u }), u += Ts[g];
    }
  }
...
class Fn {
  ...
  disposed = !1;
  constructor(t) {
    this.ownsTransport = t === void 0, this.transport = t ?? new qr({ name: "3dgs-data" }), this.transport.addEventListener("message", this.handleMessage);
  }
  async loadUrl(t, e = {}) {
...
const _s = 1 / 255, Hr = 0.99, Te = 1e-12;
function qs(n, t, e, s) {
  if (!(s > 0 && s < 1))
    throw new RangeError(
      "Gaussian raycast alphaThreshold must be between 0 and 1"
    );
  const r = t.means.array, i = t.scalesOpacity.array, a = t.rotations.array, o = new T(), l = new T(), h = new T(), u = new mr();
  let d = 1;
  for (const c of e) {
    ...
    const b = Math.max(i[p], Te), g = Math.max(i[p + 1], Te), w = Math.max(i[p + 2], Te);
    o.set(
      o.x / b,
      o.y / g,
      o.z / w
...
class Be {
  constructor(t, e, s, r) {
    this.data = t, this.leafCapacity = e, this.maxDepth = s, this.ownsData = r, this.bounds = Xr(t), this.rootBounds = Zr(this.bounds);
...
function Xr(n) {
  const t = n.means.array, e = new le(), s = new T();
...
class Kr {
  ...
  raycast(t, e, s = 0.5) {
    ...
    return o.sort((l, h) => l.distance - h.distance), qs(
      t,
      {
...
class Re extends Gs {
  ...
  raycast(t, e) {
    if (this.raycastIndex === null && (this.lod === null || this.packing === null))
      return;
    const s = new Dt().copy(this.matrixWorld).invert(), r = new fr().copy(t.ray).applyMatrix4(s), i = this.raycastIndex !== null ? this.raycastIndex.raycast(
      r,
      this.raycastMode,
...
class Fe {
  constructor(t, e) {
    this.octree = t, this.levels = ti(e.levels ?? Qr), this.ownsOctree = e.ownsOctree ?? !1;
    const s = e.importance ?? ei, r = new Float64Array(t.data.count);
...
class ri {
  ...
  budgetShares;
  constructor(t = {}) {
    this.center = t.center instanceof T ? t.center.clone() : t.center ?? "bounds-center", this.budgetShares = ii(
...
class Gn {
  ...
  pack({ lod: t, maxGaussians: e }) {
    if (Gt(e), e === 0) return ai();
    const s = De(t, this.center), r = s.map(
...
const Hs = `(function(){"use strict";function R(e){return{radii:new Float64Array(e),levels:new Uint8Array(e),order:Array.from({length:e},(n,r)=>r)}}function M(e,n,r,o,l){const s=e.leafNodeIds.length;C(s,r,o,l),x(e,n,l);const d=e.levelCount-1;let i=0;for(let t=0;t<s;t++){const u=l.order[t],h=Math.max(0,d-Math.floor(l.radii[u]/n.levelDistance));l.levels[t]=h,i+=e.levelCounts[u*e.levelCount+h]}for(let t=s-1;t>=0&&i>n.maxGaussians;t--){const u=l.order[t];for(;l.levels[t]>0&&i>n.maxGaussians;){const h=l.levels[t],f=u*e.levelCount;i-=e.levelCounts[f+h]-e.levelCounts[f+h-1],l.levels[t]=h-1}}let a=s;for(;a>0&&i>n.maxGaussians;){a--;const t=l.order[a];i-=e.levelCounts[t*e.levelCount+l.levels[a]]}for(let t=0;t<a;t++){const u=l.order[t];r[t]=e.leafNodeIds[u],o[t]=l.levels[t]}return{length:a,gaussianCount:i}}function A(e,n,r,o,l){const s=e.leafNodeIds.length;C(s,r,o,l);const d=e.levelCount-1;let i=0;for(let f=0;f<s;f++)i+=e.levelCounts[f*e.levelCount+d];if(i<=n.maxGaussians)return r.set(e.leafNodeIds),o.fill(d,0,s),{length:s,gaussianCount:i};x(e,n,l);const a=[d,Math.max(0,d-1),0];let t=0,u=0,h=0;for(let f=0;f<a.length;f++){const y=n.budgetShares[f];if(h+=y,y===0)continue;const G=f===a.length-1?n.maxGaussians:Math.floor(n.maxGaussians*h),L=a[f];for(;t<s;){const b=l.order[t],m=e.levelCounts[b*e.levelCount+L];if(u+m>G)break;r[t]=e.leafNodeIds[b],o[t]=L,u+=m,t++}}return{length:t,gaussianCount:u}}function D(e,n,r,o,l){return n.strategy==="tiered"?A(e,n,r,o,l):M(e,n,r,o,l)}function x(e,n,r){for(let o=0;o<e.leafNodeIds.length;o++){const l=o*3,s=e.leafCenters[l]-n.centerX,d=e.leafCenters[l+1]-n.centerY,i=e.leafCenters[l+2]-n.centerZ;r.radii[o]=Math.sqrt(s*s+d*d+i*i)/e.halfDiagonal,r.order[o]=o}r.order.sort((o,l)=>r.radii[o]-r.radii[l]||e.leafNodeIds[o]-e.leafNodeIds[l])}function C(e,n,r,o){if(n.length<e||r.length<e||o.radii.length<e||o.levels.length<e||o.order.length<e)throw new RangeError("Radial LOD worker buffers are too small")}const I=globalThis;let c=null,v=null;const g=[];I.onmessage=({data:e})=>{if(e.type==="init"){c=e.data,v=R(e.data.leafNodeIds.length),g.push(...e.buffers);return}if(e.type==="recycle"){g.push(e.buffer);return}if(c===null||v===null)throw new Error("Radial LOD worker was not initialized");const n=g.pop();if(n===void 0)throw new Error("Radial LOD worker exhausted its output pool");const r=new Uint32Array(n.nodeIds),o=new Uint8Array(n.lodLevels),l=performance.now(),s=D(c,e,r,o,v),d={type:"result",revision:e.revision,length:s.length,gaussianCount:s.gaussianCount,planningMs:performance.now()-l,buffer:n};I.postMessage(d,[n.nodeIds,n.lodLevels])}})();
//# sourceMappingURL=RadialLodWorker-CftnehMz.js.map
`, Cs = typeof self < "u" && self.Blob && new Blob(["(self.URL || self.webkitURL).revokeObjectURL(self.location.href);", Hs], { type: "text/javascript;charset=utf-8" });
function li(n) {
  let t;
  try {
    if (t = Cs && (self.URL || self.webkitURL).createObjectURL(Cs), !t) throw "";
    const e = new Worker(t, {
      name: n?.name
    });
    return e.addEventListener("error", () => {
...
const pi = 1024 * 1024, gi = 16, mi = 1.25;
class Ys {
  targetStrategy;
  targetPlanner;
   ...
   */
  pack(t) {
    if (Gt(t.maxGaussians), this.bindLod(t.lod), !this.initialized) {
  ...
  buildTarget(t) {
    ...
    return As(t.lod, e, t.maxGaussians), this.targetAvailable = !0, this.targetBudget = t.maxGaussians, this.targetDirty = !1, e;
  }
  refreshTarget(t) {
    ...
    if (e !== null)
      try {
        As(t.lod, e.packing, e.maxGaussians), this.targetAvailable = !0, this.targetBudget = e.maxGaussians, this.changes = this.planChanges(t.lod, e.packing), this.changeCursor = 0, this.latestTargetPlanningMs = e.planningMs, this.latestTargetRoundTripMs = e.roundTripMs;
      } finally {
        e.release();
      }
  }
...
function ks(n, t, e, s) {
  const r = n.nodes[t], i = e === null ? 0 : r.levelCounts[e], a = s === null ? 0 : r.levelCounts[s], o = Math.max(0, a - i), l = Math.max(0, i - a), h = e !== null && s !== null && e !== s ? Math.min(i, a) : 0, u = 48 + n.octree.data.shCoefficientCount * $s + 4;
  return {
    nodeId: t,
    lodLevel: s,
    gaussianDelta: a - i,
...
class yi {
  ...
  [oe](t) {
    this.assertUsable();
    const e = this.packedBuffer, s = new kt(t, 1);
...
class bi {
  ...
  commit() {
    const t = this.writtenSlots.length, e = Yt(this.writtenSlots, 16, 0.25), s = Xt(e);
    return this.freshBuffer || this.attribute[Ge](e), this.writtenSlots.length = 0, this.freshBuffer = !1, {
      writtenSlots: t,
      uploadedSlots: s,
...
class vi {
  ...
  constructor(t = {}) {
    this.loader = t.loader ?? new Vr(), this.budgetingStrategy = t.budgetingStrategy ?? new fi(), this.defaultPackingStrategy = t.defaultPackingStrategy ?? null, this.defaultStreamingLod = { ...t.defaultStreamingLod }, this.maxGaussiansOption = Si(
      t.maxGaussians ?? "auto"
    );
  }
  get maxGaussians() {
  ...
  add(t, e = {}) {
    this.assertUsable();
    const s = this.allocateObjectId(), r = Me(e.priority ?? 0), i = new Re(
      this,
      s,
      0,
      e.name,
  ...
  addLod(t, e = {}) {
    ...
    const s = this.allocateObjectId(), r = Me(e.priority ?? 0), i = new Re(
      ...
      null,
      r
    ), a = e.packingStrategy ?? this.defaultPackingStrategy ?? _i(this.defaultStreamingLod);
    return this.entries.push({
      cloud: i,
      count: 0,
  ...
  remove(t) {
    ...
    this.cloudList.splice(this.cloudList.indexOf(t), 1), s?.source !== null && s?.ownsSource === !0 && s.source.dispose(), s?.lod !== null && s?.ownsLod === !0 && s.lod.dispose(), s?.ownsPackingStrategy === !0 && Rs(s.packingStrategy), t.removeFromParent(), this.invalidatePacking();
  }
  ...
  packLodBatch(t) {
    ...
    for (const N of i.transitions) {
      const z = l.get(N.nodeId), B = N.lodLevel === null ? 0 : e.lod.nodes[N.nodeId].levelCounts[N.lodLevel], R = Math.min(
        z?.slots.length ?? 0,
        B
      );
      if (p.set(N.nodeId, {
        ...
        for (let U = R; U < z.slots.length; U++) {
          const F = z.slots[U];
          d.push(F), c.push(F);
        }
    }
    ...
    for (const N of i.transitions) {
      ...
      for (const $ of this.attributePackers)
        $.updateCell({ previousCell: B, cell: at, retainedCount: R });
      u.set(N.nodeId, at);
    }
    ...
    const S = Yt(f, 4, 0.15), _ = Yt(g, 16, 0.25);
    ...
    const C = this.commitAttributePackers(), v = this.count - e.count + i.packing.gaussianCount, M = Xt(S), I = Xt(_), k = performance.now() - h;
    return e.count = i.packing.gaussianCount, e.packing = i.packing, e.packingDirty = !1, e.cloud.updatePacking(e.count, e.packing), this.cellSlotsByEntry.set(e, u), this.freeSlots = d, this.latestPackStats = {
      fullRebuild: !1,
      ...
      estimatedUploadBytes: M * _e(o) + I * 16 + C.estimatedUploadBytes,
      writtenSlotRanges: S,
      clearedSlotRanges: _,
      planningMs: a,
      slotUpdateMs: k
  ...
  dispose() {
    if (!this.disposed) {
      ...
      for (const t of this.entries)
        t.source !== null && t.ownsSource && t.source.dispose(), t.lod !== null && t.ownsLod && t.lod.dispose(), t.ownsPackingStrategy && Rs(t.packingStrategy), t.cloud.removeFromParent();
  ...
  buildPackedData(t, e) {
    ...
    return {
      ...
      stats: {
        ...
        writtenSlots: u,
        clearedSlots: 0,
        estimatedUploadBytes: u * _e(c) + f.estimatedUploadBytes,
  ...
  updatePackedData(t, e) {
    ...
    for (const v of t) {
      ...
      for (const k of s.get(v.entry)?.values() ?? []) {
        const N = M?.get(k.nodeId), z = N?.slots, B = Math.min(z?.length ?? 0, k.count), R = z !== void 0 && z.length === k.count ? z : new Uint32Array(k.count);
        R !== z && z !== void 0 && B > 0 && R.set(z.subarray(0, B)), u += B;
        for (let F = B; F < k.count; F++) {
          const q = a.pop();
          if (q === void 0)
            throw new Error("GaussianStore slot allocator exhausted capacity");
          this.copySourceToSlot(
            v.entry,
            this.cellSourceIndex(v.entry, k.nodeId, F),
            q,
            e.means.array,
    ...
    const f = h.length, b = c.length, g = Yt(h, 4, 0.15), w = Yt(c, 16, 0.25);
    ...
    const S = this.commitAttributePackers(), _ = Xt(g), C = Xt(w);
    return {
      data: e,
      cellSlotsByEntry: l,
      freeSlots: a,
      stats: {
        ...
        writtenSlots: f,
        clearedSlots: b,
        estimatedUploadBytes: _ * _e(e) + C * 16 + S.estimatedUploadBytes,
        writtenSlotRanges: g,
        clearedSlotRanges: w,
        planningMs: 0,
        slotUpdateMs: 0
...
function _e(n) {
  return 48 + n.shCoefficientCount * js(n.shFormat);
}
function Ti(n) {
...
function Ei(n, t) {
  ...
  ), s = Ls(n.maxBufferSize, "maxBufferSize"), r = Math.max(
    16,
    (t + 1) ** 2 * js("rgb8e8")
  );
...
class Ai extends vi {
  ...
  constructor(t = {}) {
    ...
    super(t), this.ownsTransport = t.transport === void 0, this.worker = t.transport ?? new ki({ name: "3dgs-store" }), this.worker.addEventListener("message", this.handleMessage), this.worker.addEventListener("error", this.handleError), this.initialized = this.send({
      type: "init",
  ...
  enablePackedLodLevelAttribute() {
    ...
    return this.initialized.then(() => this.send({ type: "enable-lod-level" })).then((s) => {
      ...
      this.lastError = Ft(s), this.notify();
    }), e;
  }
  pack({ limits: t }) {
    ...
    this.send({ type: "pack", limits: t }).then((s) => {
      ...
      ), this.applyCloudStates(s.clouds), this.remoteInvalid = !1, this.updatePending = !0, this.lastCameraKey = "", this.layoutVersion++, this.remoteVersion++, this.notify();
    }).catch((s) => {
      this.lastError = Ft(s), this.notify();
    }).finally(() => {
      this.packInFlight = !1;
    ...
    if (!this.updateInFlight && (this.updatePending || r !== this.lastCameraKey)) {
      ...
      this.send({
        ...
        if (!(i !== this.generation || this.remoteDisposed) && (this.updatePending = a.pending, !(a.appliedBatches === 0 || this.remoteData === null))) {
          ...
          this.applyCloudStates(a.clouds), this.remoteStats = a.stats, this.remoteVersion++, this.notify();
        }
      }).catch((a) => {
        this.lastError = Ft(a), this.notify();
      }).finally(() => {
  ...
  remove(t) {
    const e = this.findCloud(t);
    e !== void 0 && (this.remoteClouds.delete(e.remoteId), t.removeFromParent(), this.generation++, this.remoteInvalid = !0, this.send({ type: "remove", cloudId: e.remoteId }).catch(
      (s) => {
        this.lastError = Ft(s);
      }
    ));
  ...
  updatePackingPriority(t, e) {
    ...
    t.updatePackingPriority(e), this.generation++, this.remoteInvalid = !0, this.send({
      type: "priority",
      cloudId: s.remoteId,
      priority: e
    }).catch((r) => {
  ...
  invalidateCloudPacking(t) {
    ...
    if (e === void 0)
      throw new Error("Cloud does not belong to this Store");
    this.generation++, this.remoteInvalid = !0, this.send({ type: "invalidate", cloudId: e.remoteId }).catch(
      (s) => {
        this.lastError = Ft(s);
      }
    );
  ...
  dispose() {
    if (!this.remoteDisposed) {
      ...
      for (const t of this.pending.values())
        t.reject(new Error("WorkerGaussianStore disposed"));
      this.pending.clear();
      for (const { cloud: t } of this.remoteClouds.values())
        t.removeFromParent();
      this.remoteClouds.clear(), this.remoteData?.dispose(), this.remoteData = null, this.changeListeners.clear(), super.dispose();
    }
  }
  attachLoaded(t, e, s, r) {
    ...
    return i.setRaycastIndex(a), this.remoteClouds.set(e, {
      ...
      sourceCount: t.count,
      degree: t.degree
    }), this.generation++, this.remoteInvalid = !0, this.notify(), i;
  }
  applyCloudStates(t) {
    for (const e of t) {
  ...
  applyPatch(t) {
    ...
    t.lodLevel !== void 0 && r?.isAllocated && (r.array.set(new Uint32Array(t.lodLevel), t.start), r[Ge](s));
  }
  send(t, e) {
    if (this.remoteDisposed)
  ...
  handleError = (t) => {
    this.lastError = new Error(t.message);
    for (const e of this.pending.values()) e.reject(this.lastError);
    this.pending.clear(), this.notify();
  };
  checkError() {
    if (this.lastError !== null) throw this.lastError;
  }
  notify() {
    for (const t of this.changeListeners) t();
  }
}
function ie(n, t, e = 4) {
  const s = new kt(t, e);
...
class $n extends yr {
  constructor(t, e = {}) {
    ...
    const h = e.opacity ?? 0.55, u = new wr({
...
class jn extends Gs {
  ...
  rebuildMeshes() {
    ...
    const e = new T(), s = new T(), r = new Dt();
    for (let i = 0; i < t.length; i++) {
      const a = t[i];
      if (a.length === 0) continue;
      const o = new vr(1, 1, 1), l = new Nr({
...
const $e = A("uint", "gaussianIndex"), je = A("uint", "gaussianObjectId"), he = A("vec3", "gaussianPositionLocal"), Qt = A("vec3", "gaussianPositionWorld"), ue = A("vec3", "gaussianScale"), ce = A("vec4", "gaussianRotation"), de = A("float", "gaussianOpacity"), We = A("vec3", "gaussianColor"), qe = A("mat4", "gaussianObjectMatrix"), He = A("bool", "gaussianObjectVisible"), Ye = A("vec3", "gaussianViewDirection"), Xe = A("float", "gaussianViewDepth"), Ze = A(
  "vec2",
...
), Ke = A("float", "gaussianProjectedArea"), pe = A("uint", "rasterGaussianIndex"), Qe = A("uint", "rasterObjectId"), ts = A("uvec2", "rasterPixelCoordinate"), es = A("vec2", "rasterScreenPosition"), ss = A("vec2", "rasterScreenUV"), rs = A("float", "rasterPixelValue"), is = A("vec2", "rasterGaussianCenter"), ns = A("vec2", "rasterPixelDelta"), tr = A("vec2", "rasterGaussianCoord"), er = A("vec2", "rasterUV"), as = A("float", "rasterViewDepth"), os = A("vec3", "rasterGaussianColor"), ls = A("float", "rasterGaussianOpacity"), hs = A("float", "rasterPower"), sr = A("float", "rasterWeight");
function Ii() {
  return {
    gaussianPositionLocalNode: he,
    gaussianPositionWorldNode: Qt,
    gaussianScaleNode: ue,
    gaussianRotationNode: ce,
    gaussianOpacityNode: de,
    gaussianColorNode: We,
    gaussianVisibilityNode: Ut(!0),
    rasterPixelValueNode: G(0),
    rasterBreakNode: Ut(!1),
    rasterColorNode: os,
    rasterAlphaNode: ls.mul(Vs(hs)),
...
class Wn {
  constructor(t, e = {}) {
    ...
    this.colors = [...e.colors ?? Oi], this.tintStrength = s, this.lodLevelAttribute = t.gaussianStore.enablePackedLodLevelAttribute(), this.unsubscribeDebug = t.subscribeDebug(() => this.update()), this.enabled = e.enabled ?? !0;
  }
  pass;
  ...
  rebuildColorNode() {
    const t = this.lodLevelAttribute.bufferAttribute, e = y(t, "uint", t.count).toReadOnly().element(pe).mod(m(this.colors.length)), s = this.colors.map((a) => {
      const o = new _r(a).getRGB(
        { r: 0, g: 0, b: 0 },
        this.pass.colorSpace
      );
      return ae(o.r, o.g, o.b);
    });
    let r = s[s.length - 1];
...
const P = 16, x = 256, Pi = 8192, V = 512, Le = 4, E = 1 << Le, it = 4, ht = x * it, K = ht, nt = 32, Bi = (
  /* wgsl */
  `
...
fn prepare_visible_dispatch(
  ...
  (*radix_reduce_dispatch)[0] = vec4<u32>(reduce_chunks, ${E}u, 1u, 0u);
...
class ut {
  ...
  createFloat(t, e, s = 4) {
    return this.track(
      t,
      new kt(new Float32Array(e * s), s)
    );
  }
  createUint(t, e, s = 1) {
    return this.track(
      t,
      new kt(new Uint32Array(e * s), s)
    );
  }
  createIndirect(t) {
    return this.track(
...
class Ki {
  constructor(t, e, s) {
    ...
    ), this.attribute = new kt(this.values, 4), this.attribute.name = "3dgs.object-frame-state";
  }
  camera;
  store;
  attribute;
  ...
  writeCloud(t) {
    ...
    this.values.set(t.matrixWorld.elements, e), this.values.set(this.modelView.elements, e + 16), this.values[e + 32] = this.cameraLocalPosition.x, this.values[e + 33] = this.cameraLocalPosition.y, this.values[e + 34] = this.cameraLocalPosition.z, this.values[e + 35] = 1, this.values[e + 36] = Qi(t, this.camera) ? 1 : 0;
  }
}
function Qi(n, t) {
...
class an {
  ...
  createComputeNode(t) {
    ...
    ), h = y(this.projectedConic, "vec4", e.count), u = y(this.projectedColor, "vec4", e.count), d = y(this.tileCounts, "uint", e.count), c = L(
      tn(this.antialiasMode)
    ), p = L(en(e.shFormat)), f = L(rn()), b = L(sn);
    return ne(() => {
      const w = m(et);
      O(w.greaterThanEqual(m(e.count)), () => {
        pt();
      }), d.element(w).assign(m(0)), l.element(w).assign(Q(0));
      const S = r.element(w), _ = S.xyz, C = m(S.w), v = i.element(w), M = v.xyz, I = v.w, k = a.element(w), N = m(e.count).add(
        C.mul(m(ze))
      ), z = ys(
        l.element(N),
        l.element(N.add(1)),
        ...
        l.element(N.add(6)),
        l.element(N.add(7))
      ), R = l.element(N.add(8)).xyz, U = l.element(N.add(9)).x.greaterThan(0);
      O(U.not(), () => {
        pt();
      });
      ...
      $.set(Ye, () => ot);
      let bt;
      if (t.gaussianPositionWorldNode === Qt)
        bt = B.mul(Q(q, 1));
      else {
        const Pt = Mt(
          t.gaussianPositionWorldNode,
      ...
      const H = st.element(0).xy, vt = st.element(0).z, At = st.element(1).xyz, Vt = st.element(1).w, Nt = st.element(2).xyz, gt = st.element(2).w, lt = new Map($);
      lt.set(Xe, () => vt), lt.set(Ze, () => H), lt.set(Je, () => Ct(Nt.xz)), lt.set(
        Ke,
        () => Ct(Vt).mul(Math.PI)
      );
      const Tt = Mt(
      ...
      const St = Pr(Rt.mul(255)), D = Ct(
        St.mul(2).mul(yt(Nt.x, 1e-12, 1e4))
      ), Lt = Ct(
        St.mul(2).mul(yt(Nt.z, 1e-12, 1e4))
      ), $t = xs(D), It = xs(Lt);
      O($t.lessThanEqual(0).or(It.lessThanEqual(0)), () => {
        pt();
      });
      const te = ft($t, It), zt = H.sub(te), W = H.add(te);
      if (O(
      ...
      const Y = Zt(bs(s.tilesX), bs(s.tilesY)).sub(1), rt = Zt(
        yt(ke(zt.div(G(P))), ft(0), ft(Y))
      ), X = Zt(
        yt(ke(W.div(G(P))), ft(0), ft(Y))
      ), tt = p({
        gid: w,
      ...
      _t.set(We, () => tt), _t.set(Ks, () => zt), _t.set(Qs, () => W);
      const ee = Mt(
        t.gaussianVisibilityNode,
        _t
      );
      ...
      l.element(w).assign(Q(H, vt, Rt)), h.element(w).assign(Q(At, $t)), u.element(w).assign(Q(Ot, It)), d.element(w).assign(dt);
...
class dn {
  constructor(t, e, s, r, i, a) {
    ...
    }).compute(e, [ln]).setName("3DGS profile subpixel coverage WGSL");
  }
  renderer;
  ...
  async readStats(t) {
    ...
    return {
      tileLoads: un(a),
      appliedTileCap: this.maxRasterizedSplatsPerTile === null ? null : zs(a, this.maxRasterizedSplatsPerTile),
      tileCapEstimates: hn.map(
        (o) => zs(a, o)
      ),
...
fn radix_scatter_${n}(
  ...
  block_bases: ptr<workgroup, array<u32, ${E}>>,
  local_digit_counts: ptr<workgroup, array<u32, ${E}>>,
  partials: ptr<workgroup, array<u32, ${E * nt}>>
) -> u32 {
  let block_start = block_index * ${ht}u;
  let count = (*state)[0].x;
  ...
  for (var item = 0u; item < ${it}u; item++) {
    ...
    if (valid) {
      ...
      digit = (record.x >> ${n}u) & ${E - 1}u;
    }

    var subgroup_prefix = 0u;
    for (var target_digit = 0u; target_digit < ${E}u; target_digit++) {
...
fn radix_workgroup_histogram_${n}(
  ...
  records: ptr<storage, array<vec2<u32>>, read>,
  block_histograms: ptr<storage, array<u32>, read_write>,
  histogram: ptr<workgroup, array<atomic<u32>, ${E}>>
) -> u32 {
  if (lane < ${E}u) {
...
fn radix_workgroup_scatter_${n}(
  ...
  shared_digit_masks: ptr<workgroup, array<u32, ${E * (x / 32)}>>
) -> u32 {
  let block_start = block_index * ${ht}u;
  let count = (*state)[0].x;
...
class Ps {
  constructor(t, e, s, r, i, a) {
    ...
    a === "subgroup" ? (u.subgroup_index = ye, u.subgroup_lane = xe, u.subgroup_size = be, u.partials = j("uint", nt)) : u.scratch = j("uint", x), this.reduceNode = h(u).computeKernel([x]).setName(`3DGS ${e} radix reduce WGSL`);
    const d = L(mn);
  ...
  configure(t) {
    this.disposePasses();
    const e = Math.ceil(Math.max(0, t) / Le);
    this.passes = Array.from(
      { length: e },
      (s, r) => this.createPass(r, r * Le)
  ...
  createPass(t, e) {
    const s = t % 2 === 0, r = s ? this.buffers.recordsA : this.buffers.recordsB, i = s ? this.buffers.recordsB : this.buffers.recordsA, a = y(this.dispatch.state, "uvec4", 1).toReadOnly(), o = y(
      ...
      this.backend === "subgroup" ? pn(e) : xn(e)
    ), h = {
      lane: xt,
      block_index: J.x,
      block_stride: m(this.maxRadixBlocks),
    ...
    this.backend === "subgroup" ? (h.subgroup_index = ye, h.subgroup_lane = xe, h.subgroup_size = be, h.partials = j(
      "uint",
      E * nt
    )) : h.histogram = j("atomic<u32>", E);
    const u = l(h).computeKernel([x]).setName(`3DGS ${this.label} radix histogram WGSL ${t}`), d = L(
      this.backend === "subgroup" ? yn(e) : wn(e)
    ), c = {
      lane: xt,
      block_index: J.x,
      block_stride: m(this.maxRadixBlocks),
      ...
      block_bases: j("uint", E),
      local_digit_counts: j("uint", E)
    };
    this.backend === "subgroup" ? (c.subgroup_index = ye, c.subgroup_lane = xe, c.subgroup_size = be, c.partials = j(
      "uint",
      E * nt
...
class Mn {
  constructor(t, e, s, r, i) {
    ...
    const a = y(this.offsets, "uint", s + 1), o = L(vn);
    this.clearNode = o({
      index: et,
      tile_count: m(s),
      state: y(i.state, "uvec4", 1).toReadOnly(),
    ...
    this.boundariesNode = l({
      ...
      offsets: a
    }).computeKernel([x]).setName(`3DGS find tile boundaries WGSL (${e})`), this.suffixMin = new _n(this.offsets, s + 1);
  }
  renderer;
  dispatch;
  offsets;
...
class En {
  constructor(t, e, s, r, i, a, o, l, h, u, d, c, p, f, b, g, w, S = !1, _ = 1e-4, C = 0.95) {
    ...
    this.clearMetrics = v === null ? null : ne(() => {
      Br(v.element(et), m(0));
  ...
  createChunkSchedule() {
    ...
    const t = nr(
      ...
      tile_offsets: h,
      chunk_counts: u
    }).compute(this.tileCount, [x]).setName("3DGS count exact raster chunks WGSL"), g = L(
      Fi
    )({
      tile_count: m(this.tileCount),
      task_capacity: m(t),
    ...
    }).compute(1).setName("3DGS prepare exact raster chunk dispatch WGSL"), S = L(Ui)({
      tile: et,
      tile_count: m(this.tileCount),
      task_capacity: m(t),
      chunk_counts: d,
  ...
  createRasterNode(t, e) {
    const s = this.metrics === null ? null : y(this.metrics, "uint", this.tileCount * 4).toAtomic(), r = y(
      ...
      "uint",
      this.tileOffsetsAttribute.count
    ).toReadOnly(), u = j("vec4", x), d = j("vec4", x), c = j("vec4", x), p = j("uint", x), f = j("uint", x), b = j("uint", 8), g = e === "direct" ? Ae(this.colorTexture) : null, w = L(Bs), S = L(Cn), _ = this.chunks, C = e === "chunk" && _ !== null ? y(_.tasks, "uvec2", _.tasks.count).toReadOnly() : null, v = e === "chunk" && _ !== null ? y(_.partialData, "vec4", _.partialData.count) : null, { frame: M } = this;
    return ne(() => {
      const k = m(xt), N = w({ value: k }), z = w({ value: k.shiftRight(1) }), B = m(J.x), R = (e === "direct" ? J.y.mul(M.tilesX).add(J.x) : C.element(B).x).toVar("rasterTile"), U = e === "chunk" ? C.element(B).y : m(0), F = e === "direct" ? J.x : R.mod(M.tilesX), q = e === "direct" ? J.y : R.div(M.tilesX), at = Kt(
        F.mul(m(P)).add(N),
        q.mul(m(P)).add(z)
      ).toVar("rasterPixelCoordinateValue"), $ = at.x.lessThan(m(M.viewport.x)).and(at.y.lessThan(m(M.viewport.y))).toVar("rasterActivePixel"), ot = h.element(R), bt = h.element(R.add(1)), wt = m(bt.sub(ot)), ct = wt.toVar("rasterTileSampleCount");
      ...
      const vt = ft(at).add(0.5), At = /* @__PURE__ */ new Map([
        [ts, () => at],
        [es, () => vt],
        [ss, () => vt.div(M.viewport.xy)]
      ]), Vt = G(0).toVar("rasterPixelValue");
      O($, () => {
        Vt.assign(
          Ht(t.rasterPixelValueNode, At)
        );
      });
      const Nt = ae(0).toVar("accumulated"), gt = G(1).toVar("transmittance"), lt = G(0).toVar("weightedViewDepth"), Tt = Ut(!1).toVar("done"), Rt = s === null ? null : m(0).toVar("rasterChecked"), St = s === null ? null : m(0).toVar("rasterBlended");
      Wt(
        {
          start: st,
          end: H,
        ...
        ({ i: D }) => {
          ...
          O(Lt.lessThan(H), () => {
            ...
            this.maxSplatsPerTile !== null && (W = m(
              ke(
                G(Lt).add(0.5).mul(G(wt)).div(G(ct))
              )
            ));
            const Y = ot.add(W).toVar("rasterSourceRecordIndex"), rt = l.element(Y).y, X = i.element(rt), tt = a.element(rt);
            u.element(k).assign(X), d.element(k).assign(Q(tt.xyz, X.w.mul(255).log())), c.element(k).assign(o.element(rt)), p.element(k).assign(rt);
          }), O(k.equal(0), () => {
          ...
          const $t = S({ values: f }).toVar("hasNextBatch"), It = m(H.sub(D)), te = mt(
            It.lessThan(m(x)),
            It,
            m(x)
          );
          O($.and(Tt.not()), () => {
            Wt(
              ...
              ({ i: W }) => {
                ...
                tt.set(rs, () => Vt), tt.set(pe, () => rt), tt.set(
                  Qe,
                  () => m(r.element(rt).w)
                ), tt.set(is, () => Y.xy), tt.set(ns, () => X), tt.set(as, () => Y.z);
                const _t = Ht(
                  t.rasterBreakNode,
                  tt
                );
                ...
                const ee = d.element(W), dt = ee.xyz, Ot = dt.x.mul(X.x.mul(X.x)).add(dt.y.mul(2).mul(X.x).mul(X.y)).add(dt.z.mul(X.y.mul(X.y))).mul(-0.5);
                O(
                  Ot.greaterThan(0).or(Ot.lessThan(ee.w.negate())),
                  () => {
                    we();
                  }
                );
                const Pt = Ct(ws(dt.x, 1e-12)), ge = dt.y.div(Pt), dr = Ct(ws(dt.z.sub(ge.mul(ge)), 1e-12)), cs = ft(
                  Pt.mul(X.x).add(ge.mul(X.y)),
                  dr.mul(X.y)
                ), me = new Map([
                  ...tt,
                  [tr, () => cs],
                  ...
                  [hs, () => Ot],
                  [sr, () => Vs(Ot)]
                ]), pr = Ht(t.rasterDiscardNode, me);
                O(pr, () => {
                  we();
                });
                const fe = yt(
                  Ht(t.rasterAlphaNode, me),
                  0,
                  0.99
                );
                O(fe.lessThan(G(1 / 255)), () => {
                  we();
                });
                const gr = Ht(t.rasterColorNode, me), ds = gt.mul(fe).toVar("rasterContribution");
                Nt.addAssign(gr.mul(ds)), lt.addAssign(Y.z.mul(ds)), St?.addAssign(1), gt.mulAssign(G(1).sub(fe)), O(gt.lessThan(this.transmittanceThreshold), () => {
                  Tt.assign(Ut(!0)), qt();
                });
              }
            );
            ...
            qt();
          }), f.element(k).assign(mt($.and(Tt.not()), m(1), m(0))), vs(), O(k.lessThan(8), () => {
            const W = k.mul(32), Y = m(0).toVar("subgroupActive");
            Wt(
        ...
        if (s !== null) {
          const D = R.mul(4);
          Bt(s.element(D), Rt), Bt(s.element(D.add(1)), St), e === "direct" && O(wt.greaterThan(0).and(H.greaterThan(0)), () => {
        ...
        if (e === "direct")
          ...
          const D = B.mul(m(x)).add(k).mul(m(_.partialStride));
  ...
  createCompositeNode() {
    const t = this.metrics === null ? null : y(this.metrics, "uint", this.tileCount * 4).toAtomic(), e = this.chunks, s = y(
      ...
      "vec4",
      e.partialData.count
    ).toReadOnly(), a = Ae(this.colorTexture), o = L(Bs), { frame: l } = this;
    return ne(() => {
      const u = m(xt), d = o({ value: u }), c = o({ value: u.shiftRight(1) }), p = J.y.mul(l.tilesX).add(J.x), f = s.element(p), b = Kt(
        J.x.mul(m(P)).add(d),
        J.y.mul(m(P)).add(c)
      ), g = b.x.lessThan(m(l.viewport.x)).and(b.y.lessThan(m(l.viewport.y)));
      O(g.and(f.greaterThan(0)), () => {
        const w = ae(0).toVar("chunkCompositeColor"), S = G(1).toVar("chunkCompositeTransmittance"), _ = G(0).toVar(
...
function Fs(n, t, e, s, r, i, a, o) {
  const l = yt(G(a.background[3]), 0, 1);
  n.addAssign(
    ae(a.background[0], a.background[1], a.background[2]).mul(t).mul(l)
  );
  const h = G(1).sub(t.mul(G(1).sub(l)));
  if (Ns(r, Zt(s), Q(n, h)), i !== null) {
...
class Rn {
  constructor(t, e, s, r, i, a, o, l, h, u, d, c, p, f, b = 1e-4, g = !1, w = 0.95) {
    this.renderer = t, this.data = s, this.mode = i, this.capacity = o, this.profileKernels = h, this.maxRasterizedSplatsPerTile = u, this.rasterChunkSize = d, this.subpixelSampleCulling = c, this.radixBackend = p, this.nodes = f, this.rasterTransmittanceThreshold = b, this.rasterStats = g, this.depthAlphaThreshold = w, this.frame = new Yi(e, l), this.objects = new Ki(e, r, s.count), this.projection = new an(
      ...
      f,
      c
    ), this.profileDiagnostics = h || g ? new dn(
      t,
      s.count,
  ...
  rebuildTileStages(t, e, s, r) {
    ...
    this.sorter.configure(l), this.tileOffsets = new Mn(
      this.renderer,
      this.mode,
      o,
      this.sorter.sortedRecords,
      this.intersections.dispatch
    ), this.rasterizer = new En(
      this.renderer,
      this.data.count,
      this.capacity,
      this.mode,
...
class In extends ps {
  ...
  constructor(t, e, s, r = {}) {
    ...
    const c = r.rasterChunkSize === void 0 ? Pi : r.rasterChunkSize;
    if (Di(
      c,
      u ?? x * 65535
    ), this.name = "GaussianPass", this.ownerRenderer = t, this.gaussianStore = s, s instanceof Ai && (this.unsubscribeStore = s.subscribe(() => this.invalidate())), this.redrawStrategy = o, this.depthSortMode = i, this.antialiasMode = a, this.requestedIntersectionCapacity = u, this.background = r.background ?? [0, 0, 0, 0], this.outputDepth = r.outputDepth ?? !1, this.depthAlphaThreshold = r.depthAlphaThreshold ?? 0.95, !Number.isFinite(this.depthAlphaThreshold) || this.depthAlphaThreshold < 0 || this.depthAlphaThreshold > 1)
      throw new RangeError("depthAlphaThreshold must be finite and in [0, 1]");
    if (this.colorSpace = r.colorSpace ?? Er, this.profileKernels = r.profileKernels ?? !1, this.rasterStats = r.rasterStats ?? !1, this.rasterTransmittanceThreshold = r.rasterTransmittanceThreshold ?? 1e-4, !Number.isFinite(this.rasterTransmittanceThreshold) || this.rasterTransmittanceThreshold <= 0 || this.rasterTransmittanceThreshold >= 1)
      throw new RangeError(
        "rasterTransmittanceThreshold must be finite and in (0, 1)"
      );
    this.maxRasterizedSplatsPerTile = d, this.rasterChunkSize = c, this.subpixelSampleCulling = r.subpixelSampleCulling ?? !0, this.radixBackend = h, this.renderTarget.texture.dispose(), this.colorTexture = new ms(1, 1), this.colorTexture.name = "GaussianPass.output", this.colorTexture.type = gs, this.colorTexture.colorSpace = kr, this.colorTexture.generateMipmaps = !1, Object.assign(this.colorTexture, { mipmapsAutoUpdate: !1 }), this.colorTexture.isRenderTargetTexture = !0, this.colorTexture.renderTarget = this.renderTarget, this.renderTarget.texture = this.colorTexture, this.outputDepth ? (this.depthTexture = new ms(1, 1), this.depthTexture.name = "GaussianPass.depth", this.depthTexture.format = Ar, this.depthTexture.type = Rr, this.depthTexture.minFilter = fs, this.depthTexture.magFilter = fs, this.depthTexture.generateMipmaps = !1, Object.assign(this.depthTexture, { mipmapsAutoUpdate: !1 })) : this.depthTexture = null;
  }
  ...
  getColorNode() {
    return this.workingColorNode ??= Fr(
  ...
  updateBefore(t) {
    ...
    if (!(this.camera instanceof Lr))
      throw new TypeError(
        "GaussianPass currently requires a PerspectiveCamera"
      );
    e.getDrawingBufferSize(Ce);
    const s = Math.max(1, Math.floor(Ce.x)), r = Math.max(1, Math.floor(Ce.y)), i = this.getResolutionScale(), a = Math.max(1, Math.floor(s * i)), o = Math.max(
      1,
      Math.floor(r * i)
    );
    ...
    if (this.gaussianStore.needsPack && this.gaussianStore.pack({ limits: zn(e) }), !this.gaussianStore.hasPackedData) return;
  ...
  setProjectionNode(t, e) {
    Ds(e, t), this.nodeSlots[t] !== e && (this.nodeSlots[t] = e, this.invalidateProjection());
  }
  setRasterNode(t, e) {
    Ds(e, t), this.nodeSlots[t] !== e && (this.nodeSlots[t] = e, this.invalidateRasterizer());
  }
  ...
  autoInputsChanged(t, e) {
    ...
    if (s === null) return !0;
    const r = this.camera;
    if (r.updateWorldMatrix(!0, !1), s.width !== t || s.height !== e || s.cameraNear !== r.near || s.cameraFar !== r.far || s.cameraLayers !== r.layers.mask || s.storeContentVersion !== this.gaussianStore.contentVersion || !Ee(
      s.projectionMatrix,
    ...
    for (let i = 0; i < s.clouds.length; i++) {
      ...
      if (o.updateWorldMatrix(!0, !1), a.cloud !== o || a.visible !== Us(o, r) || !Ee(a.matrixWorld, o.matrixWorld.elements))
        return !0;
    }
    return !1;
  }
...
function qn(n, t, e, s) {
  return new In(n, t, e, s);
}
export {
  Vr as CanonicalGaussianPlyLoader,
  Gn as DistanceAwareRadialLodPackingStrategy,
  Ur as FLOAT32_SH_BYTES_PER_COEFFICIENT,
  Re as GaussianCloud,
  Pe as GaussianData,
  Fn as GaussianDataBackend,
  Fe as GaussianLod,
  Wn as GaussianLodColorHelper,
  Ms as GaussianLodNode,
  Be as GaussianOctree,
  Yr as GaussianOctreeNode,
  In as GaussianPass,
  Kr as GaussianRaycastIndex,
  vi as GaussianStore,
  xi as GaussianStoreAttributes,
  yi as GaussianStorePackedAttribute,
  jn as LodHelper,
  Un as MaximumLodPackingStrategy,
  $n as OctreeHelper,
  $s as RGB8E8_SH_BYTES_PER_COEFFICIENT,
  Dn as RadialLodPackingStrategy,
  ui as RadialLodWorkerPlanner,
  fi as RemainingCapacityBudgetStrategy,
  Vn as SourceFractionBudgetStrategy,
  Ys as StreamingLodPackingStrategy,
  ri as TieredRadialLodPackingStrategy,
  Ai as WorkerGaussianStore,
  We as gaussianColor,
  $e as gaussianIndex,
  je as gaussianObjectId,
  qe as gaussianObjectMatrix,
  He as gaussianObjectVisible,
  de as gaussianOpacity,
  qn as gaussianPass,
  he as gaussianPositionLocal,
  Qt as gaussianPositionWorld,
  Ke as gaussianProjectedArea,
  Je as gaussianProjectedSigma,
  ce as gaussianRotation,
  ue as gaussianScale,
  Qs as gaussianScreenBoundsMax,
  Ks as gaussianScreenBoundsMin,
  Ze as gaussianScreenPosition,
  Xe as gaussianViewDepth,
  Ye as gaussianViewDirection,
  Es as isStreamingLodPackingStrategy,
  Dr as packShRgb8e8,
  is as rasterGaussianCenter,
  os as rasterGaussianColor,
  tr as rasterGaussianCoord,
  pe as rasterGaussianIndex,
  ls as rasterGaussianOpacity,
  Qe as rasterObjectId,
  ts as rasterPixelCoordinate,
  ns as rasterPixelDelta,
  rs as rasterPixelValue,
  hs as rasterPower,
  es as rasterScreenPosition,
  ss as rasterScreenUV,
  er as rasterUV,
  as as rasterViewDepth,
  sr as rasterWeight,
  js as shBytesPerCoefficient,
  Bn as unpackShRgb8e8
};
