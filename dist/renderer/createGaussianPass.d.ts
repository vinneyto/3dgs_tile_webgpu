...
export declare function gaussianPass(renderer: WebGPURenderer, camera: PerspectiveCamera, gaussianStore: GaussianRenderStore, options?: GaussianPassOptions): GaussianPass;
