 ...
 */
export declare function maxRasterChunkTasks(intersectionCapacity: number, chunkSize: number): number;
export declare function validateRasterChunkSize(chunkSize: number | null, intersectionCapacity: number): void;
