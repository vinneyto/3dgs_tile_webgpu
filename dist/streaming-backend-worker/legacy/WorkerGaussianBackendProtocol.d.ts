import type { GaussianStorePackLimits, GaussianStorePackStats, GaussianStoreSlotRange } from "../../renderer/GaussianStore";
...
export interface WorkerStoreTransport {
    ...
    addEventListener(type: "message", listener: (event: MessageEvent<WorkerStoreResult>) => void): void;
    addEventListener(type: "error", listener: (event: ErrorEvent) => void): void;
    removeEventListener(type: "message", listener: (event: MessageEvent<WorkerStoreResult>) => void): void;
